...
class TestValueZoneClosures:
    ...
    def test_aggregation_combo_correct_index(self, mock_state, qtbot):
        ...
        assert new_aggs == [AggregationType.COUNT, AggregationType.MEAN, AggregationType.MAX]
        ...
        new_aggs = [vc.aggregation for vc in mock_state.value_columns]
        assert new_aggs == [AggregationType.COUNT, AggregationType.MEAN, AggregationType.MIN]
