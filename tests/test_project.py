...
class TestDataSourceRef:
    ...
    def test_absolute_path(self):
        """절대 경로"""
        ref = DataSourceRef(path="C:/data/sales.csv", file_type="csv")
    ...
    def test_relative_path(self):
        """상대 경로"""
        ref = DataSourceRef(path="data/sales.csv", file_type="csv")
    ...
    def test_to_dict(self):
        """직렬화"""
        ref = DataSourceRef(
            path="data.csv", file_type="csv", encoding="utf-8", delimiter=","
        )
    ...
    def test_from_dict(self):
        """역직렬화"""
        data = {"path": "data.parquet", "file_type": "parquet"}
...
class TestProject:
    ...
    def test_project_data_source(self):
        ...
        project.data_source = DataSourceRef(path="sales.csv", file_type="csv")
    ...
    def test_project_dashboard(self):
        ...
        project.dashboards = [
            {"name": "Overview", "layout": {"rows": 2, "cols": 2}, "items": []}
        ]
    ...
    def test_project_metadata(self):
        """메타데이터"""
        project = Project(name="Test", author="John", description="Test project")
...
class TestProjectSerialization:
    ...
    def sample_project(self):
        ...
        project.data_source = DataSourceRef(path="data/sales.csv", file_type="csv")
        project.state = {
...
class TestProjectFileIO:
    ...
    def sample_project(self):
        ...
        project.data_source = DataSourceRef(path="test.csv", file_type="csv")
...
class TestProjectValidation:
    ...
    def test_validate_data_source_exists(self):
        """데이터 소스 존재 확인"""
        project = Project(name="Test")
        project.data_source = DataSourceRef(path="nonexistent.csv", file_type="csv")

        errors = project.validate()

        assert any("data source" in e.lower() or "file" in e.lower() for e in errors)
