...
class TestCategoricalDetection:
    ...
    def test_string_column_is_categorical(self):
        ...
        engine = DataEngine()
        engine._df = pl.DataFrame({"category": ["A", "B", "C", "A", "B", "C"] * 100})
    ...
    def test_numeric_column_not_categorical(self):
        ...
        engine = DataEngine()
        engine._df = pl.DataFrame({"numbers": list(range(1000))})
    ...
    def test_few_unique_numbers_is_categorical(self):
        ...
        engine._df = pl.DataFrame({"grade": [1, 2, 3] * 334})
    ...
    def test_boolean_is_categorical(self):
        ...
        engine = DataEngine()
        engine._df = pl.DataFrame({"flag": [True, False, True, False, True]})
    ...
    def test_get_unique_values(self):
        ...
        engine = DataEngine()
        engine._df = pl.DataFrame({"category": ["C", "A", "B", "A", "C", "B"]})
