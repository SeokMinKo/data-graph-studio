...
class TestShortcut:
    ...
    def test_shortcut_custom_key(self):
        ...
        keys_str = (
            ...
            if hasattr(shortcut.keys, "toString")
...
class TestShortcutCustomization:
    ...
    def test_reset_shortcut(self, manager):
        ...
        original_str = (
            original_shortcut.keys.toString()
            if hasattr(original_shortcut.keys, "toString")
            else str(original_shortcut.keys)
        )
        ...
        reset_str = (
            reset_shortcut.keys.toString()
            if hasattr(reset_shortcut.keys, "toString")
            else str(reset_shortcut.keys)
        )
...
class TestShortcutPersistence:
    ...
    def test_from_dict(self, manager):
        """딕셔너리에서 복원"""
        data = {"customized": {"file.open": "Ctrl+Shift+O"}}
