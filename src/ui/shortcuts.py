...
class ShortcutManager:
    ...
    def register_defaults(self):
        """기본 단축키 등록"""
        # File
        self.register("file.open", "Open File", QKeySequence.StandardKey.Open, ShortcutCategory.FILE)
        self.register("file.save", "Save Project", QKeySequence.StandardKey.Save, ShortcutCategory.FILE)
        self.register("file.save_as", "Save As", QKeySequence.StandardKey.SaveAs, ShortcutCategory.FILE)
        self.register("file.close", "Close", QKeySequence.StandardKey.Close, ShortcutCategory.FILE)
        self.register("file.quit", "Quit", QKeySequence.StandardKey.Quit, ShortcutCategory.FILE)
        
        # Edit
        self.register("edit.undo", "Undo", QKeySequence.StandardKey.Undo, ShortcutCategory.EDIT)
        self.register("edit.redo", "Redo", QKeySequence.StandardKey.Redo, ShortcutCategory.EDIT)
        self.register("edit.cut", "Cut", QKeySequence.StandardKey.Cut, ShortcutCategory.EDIT)
        self.register("edit.copy", "Copy", QKeySequence.StandardKey.Copy, ShortcutCategory.EDIT)
        self.register("edit.paste", "Paste", QKeySequence.StandardKey.Paste, ShortcutCategory.EDIT)
        self.register("edit.select_all", "Select All", QKeySequence.StandardKey.SelectAll, ShortcutCategory.EDIT)
        self.register("edit.deselect", "Deselect", "Escape", ShortcutCategory.EDIT)
        self.register("edit.delete", "Delete", QKeySequence.StandardKey.Delete, ShortcutCategory.EDIT)
        
        # View
        self.register("view.zoom_in", "Zoom In", QKeySequence.StandardKey.ZoomIn, ShortcutCategory.VIEW)
        self.register("view.zoom_out", "Zoom Out", QKeySequence.StandardKey.ZoomOut, ShortcutCategory.VIEW)
        self.register("view.reset", "Reset View", "Home", ShortcutCategory.VIEW)
        self.register("view.autofit", "Autofit", "F", ShortcutCategory.VIEW)
        self.register("view.fullscreen", "Fullscreen", QKeySequence.StandardKey.FullScreen, ShortcutCategory.VIEW)
        ...
        # Data
        self.register("data.refresh", "Refresh Data", QKeySequence.StandardKey.Refresh, ShortcutCategory.DATA)
    ...
    def get_help_text(self) -> str:
        ...
        for category in ShortcutCategory:
            ...
            if shortcuts:
                lines.append(f"\n{category.value}:")
                for s in shortcuts:
                    keys_str = s.keys.toString() if isinstance(s.keys, QKeySequence) else str(s.keys)
        ...
        for category in ShortcutCategory:
            ...
            if shortcuts:
                result[category.value] = [
                    {
                        'keys': s.keys.toString() if isinstance(s.keys, QKeySequence) else str(s.keys),
                        'name': s.name,
